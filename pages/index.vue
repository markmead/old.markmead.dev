  ...
  >
    <div class="container py-16 space-y-12 sm:py-32">
      ...
      <p>
        ...
        Senior Developer at
        <index-external-link url="https://www.wearefuze.co.uk/" text="FUZE" />,
        a creative marketing agency helping brands go further.
      </p>

      <p>
        I have a selection of
        <index-internal-link name="projects" text="featured projects" /> and
        <index-internal-link name="blogs" text="development blogs" /> where I
        talk about the current stack that I’m using.
      </p>
